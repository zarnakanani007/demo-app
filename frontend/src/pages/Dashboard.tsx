...
//           You are not able to authorized ,Only <strong> ADMIN </strong> can able  to authorized! 
//         </h1>
//       </div>
//     );
//   }
...
//           className="bg-green-600 text-white px-6 py-3 rounded-xl shadow hover:bg-green-700 transition duration-200"
//         >
//           View Users
//         </button>
...
//           className="bg-purple-600 text-white px-6 py-3 rounded-xl shadow hover:bg-purple-700 transition duration-200"
//         >
//           View Products
//         </button>
//       </div>
