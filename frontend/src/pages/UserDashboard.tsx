...
import { FaSearch, FaFilter, FaShoppingCart, FaStar, FaTag } from "react-icons/fa";
...
const UserDashboard: React.FC = () => {
  ...
  const handleAddToCart = (product: any) => {
    ...
    dispatch(addToCart({
      ...
      quantity: 1,
      image: product.image,
      category: product.category // ADD category to cart
    }));
  ...
  const filteredProducts = products
    .filter(product => 
      ...
      (selectedCategory === "all" || product.category === selectedCategory) // ADD category filter
    )
