...
//   const [sortOption, setSortOption] = useState("date"); // "date" or "total"
...
//   // Filter orders by order ID or product name
...
//   if (orders.length === 0)
//     return <p className="text-center mt-10">You have not placed any orders yet.</p>;
...
//           className="w-full sm:w-1/4 px-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
//         >
//           <option value="date">Sort by Date (Newest)</option>
//           <option value="total">Sort by Total (Highest)</option>
//         </select>
//       </div>
...
//               <h3 className="font-semibold">Order ID: {highlightText(order._id)}</h3>
...
//                       <tr key={item._id}>
//                         <td className="border px-4 py-2">{highlightText(item.name)}</td>
