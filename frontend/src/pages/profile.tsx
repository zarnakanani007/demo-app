...
// import { FiCamera } from "react-icons/fi"; // camera/edit icon
...
//         setOriginalAvatar(res.data.avatar || null);
...
//     }
//     setEditing(true); // automatically enable editing when avatar changes
//   };
...
//       setAvatarPreview(res.data.user.avatar + `?t=${Date.now()}`);
...
//             className="absolute bottom-0 right-[250px] rounded-full p-2 cursor-pointer border bg-white"
//             title="Change Avatar"
//           >
//             <FiCamera size={20} />
//           </div>
...
//       {/* Past Orders */}
//       <h3 className="text-xl font-semibold mt-8 mb-2">Past Orders</h3>
//       {loadingOrders ? (
//         <p>Loading orders...</p>
//       ) : orders.length > 0 ? (
...
// import { useNavigate } from "react-router-dom";
// import { FaUser, FaEdit, FaShoppingBag, FaEnvelope, FaCalendar } from "react-icons/fa";
...
//                   className={`w-full text-left px-4py-3 rounded-lg transition-colors ${
//                     activeTab === "settings" 
//                       ? "bg-blue-50 text-blue-600 border border-blue-200" 
//                       : "text-gray-600 hover:bg-gray-50"
//                   }`}
...
//                 className="w-full mt-6 flex items-center justify-center gap-2 px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-semibold"
//               >
...
//                 </div>
//                 <div className="p-6">
//                   {/* Orders content from previous component */}
//                 </div>
//               </div>
//             )}
